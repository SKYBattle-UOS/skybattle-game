...
public class Player extends PlayerCommon {
    protected Player(float latitude, float longitude, String name) {
        ...
        _skills[0] = new WazakWazakCommon(0);//new SneakCommon(0);//new WazakWazakCommon(0);
        _skills[1] = new GlobalWazakWazakCommon(1);//new DuplicationTrickCommon(1);//new GlobalWazakWazakCommon(1);
