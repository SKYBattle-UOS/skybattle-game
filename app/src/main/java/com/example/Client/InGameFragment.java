...
public class InGameFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btn_q.setOnClickListener(v -> Core.getInstance().getInputManager().q());

        Button btn_w = view.findViewById(R.id.btn_w);
        btn_w.setOnClickListener(v -> Core.getInstance().getInputManager().w());

        Button btn_e = view.findViewById(R.id.btn_e);
        btn_e.setOnClickListener(v -> Core.getInstance().getInputManager().e());

        Button btn_r = view.findViewById(R.id.btn_r);
        btn_r.setOnClickListener(v -> Core.getInstance().getInputManager().r());
